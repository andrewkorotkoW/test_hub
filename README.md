...
папки — по доле зелёных тестов внутри. При первой отрисовке ветви анимированно
«вырастают» от корня, раскрытие/сворачивание узла плавно перекладывает
соседей, упавшие тесты мягко пульсируют. Наведение подсвечивает путь от корня
до узла и связанные маршруты на карте; клик по тесту открывает ту же панель
связей, что и клик по ячейке карты. Переключатель раскладки (сверху вниз /
радиальная), зум и панорамирование колесом/перетаскиванием; глубокие уровни
по умолчанию свёрнуты, чтобы не превышать ~200 видимых узлов одновременно.
